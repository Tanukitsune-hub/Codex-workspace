...
- Keep this repository lightweight. Do not add a framework, build system, server, or dependency unless the handoff requires it.
- Preserve GitHub Pages/static-file compatibility. Validate changed HTML/CSS/JavaScript, relative paths, and the primary page with a focused smoke check.
